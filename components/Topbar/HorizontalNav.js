      ...
      <Menu
        ...
        <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="in-built-apps"
          ...
          <Menu.Item key="in-built-apps/mail">
            <Link to="/in-built-apps/mail"><i className="icon icon-email"/><FormattedMessage
          ...
          <Menu.Item key="in-built-apps/contacts">
            <Link to="/in-built-apps/contacts"><i className="icon icon-contacts"/><FormattedMessage
...
export default withIntl(HorizontalNav);
