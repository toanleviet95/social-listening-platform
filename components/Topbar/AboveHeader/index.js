          ...
          <div className="gx-container">
            <div className="gx-header-horizontal-top-flex">
              <div className="gx-header-horizontal-top-left">
                ...
                <p className="gx-mb-0 gx-text-truncate"><FormattedMessage id="app.announced"/></p>
              </div>
              <ul className="gx-login-list">
                <li><FormattedMessage id="app.userAuth.login"/></li>
                <li><FormattedMessage id="app.userAuth.signUp"/></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="gx-container">
            <div className="gx-header-horizontal-main-flex">
              ...
              <span className="gx-pointer gx-flex-row gx-align-items-center"><i
                className={`flag flag-24 flag-${locale && locale.icon || ''}`}/>
              </span>
                  </Popover>
                </li>
